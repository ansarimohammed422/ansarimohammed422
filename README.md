...
*Click on any badge to view the official documentation for that technology.*
...
*Proficient in Python, JavaScript, Java, C++, C, C# (Basics).*
...
*Experienced with React, HTML, CSS, Tailwind CSS.*
...
*Skilled in Django, Django REST Framework, REST APIs, PHP.*
...
* Working knowledge of MySQL, SQL Databases.
* Version control & environments: Git, Linux CLI (Command Line Interface), npm, pip.
* Core foundations: Object-Oriented Programming (OOP), Data Structures, Algorithms, Scripting.
...
When I'm not writing code or debugging, my life is driven by discipline, aesthetics, and great storytelling:
* **Iron & Gravity:** Dedicated to Mike Mentzer's High-Intensity Training (HIT) philosophy and perfecting calisthenics movements (front levers, handstands, and muscle-ups).
* **Two Wheels:** Cruising the streets on my Yamaha RX100.
* **Cinema & Lore:** I'm a massive fan of Korean thrillers (from Bong Joon-ho and Park Chan-wook), Vishal Bhardwaj's atmospheric cinema, and analyzing the deep lore and character writing of anime like *Monster*, *Classroom of the Elite*, *Pantheon*, and *The Daily Life of the Immortal King*.
...
* 🐙 **GitHub:** [ansarimohammed422](https://github.com/ansarimohammed422)
* 🌐 **Portfolio:** [Mohammed Ansari - Vercel Portfolio](https://mohammed-portfolio-gilt-three.vercel.app/)
